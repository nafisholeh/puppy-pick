...
const Button = ({ children, onClick, state = "default", theme = "primary", ...buttonProps }) => {
  ...
  const baseClasses = `flex items-center justify-center px-6 py-3 gap-4 text-lg font-medium rounded-lg bg-yellow-600 hover:bg-yellow-800 transition-colors duration-200 ${primaryTheme ? "text-black" : "text-yellow-600 border border-[1.5px] border-yellow-600"}`;
